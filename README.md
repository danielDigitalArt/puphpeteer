...
[![PHP Version](https://img.shields.io/packagist/php-v/danieldigitalart/puphpeteer.svg?style=flat-square)](http://php.net/)
[![Composer Version](https://img.shields.io/packagist/v/danieldigitalart/puphpeteer.svg?style=flat-square&label=Composer)](https://packagist.org/packages/zoon/puphpeteer)
[![Node Version](https://img.shields.io/node/v/@danieldigitalart/puphpeteer.svg?style=flat-square&label=Node)](https://nodejs.org/)
[![NPM Version](https://img.shields.io/npm/v/@danieldigitalart/puphpeteer.svg?style=flat-square&label=NPM)](https://www.npmjs.com/package/@nesk/puphpeteer)
[![Build Status](https://img.shields.io/travis/danieldigitalart/puphpeteer.svg?style=flat-square&label=Build%20Status)](https://travis-ci.org/nesk/puphpeteer)

A [Puppeteer](https://github.com/GoogleChrome/puppeteer/) bridge for PHP, supporting the entire API. Based on [Rialto](https://github.com/danieldigitalart/rialto/), a package to manage Node resources from PHP.
...
```shell
composer require danieldigitalart/puphpeteer
npm install github:danieldigitalart/puphpeteer
```
